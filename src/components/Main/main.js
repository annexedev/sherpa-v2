...
function ServiceDetailsEmployeurs(props) {
   ...
   const cmsBlockData = useCmsBlock({
      ...
      if(props.id % 2 == 0) {
         var customClass = "justify-content-center d-flex team-flex align-items-start align-items-lg-end justify-content-lg-end";
      } else {
         var customClass = "justify-content-center d-flex team-flex align-items-start justify-content-lg-start";
      }

   return (
    <>
      <div class="p-0 col-md-6 col-sm-12 team-item" id={"block-"+props.id}>
                  ...
                  <Popup
                        trigger={<button className="button">
                             <div class="image-anchor">
                                <img class="zoom" src={picture} alt={name}/>
                    ...
                    >
                            ...
                            <div className="content">
                                ...
                                <div id="modal-content-1" class="modal-content modal-slide" data-role="content">
                                    ...
                                    <div class="modal-body-content">
                                        <img class="member-pic" src={picture}/>
                                        <div class="member-info-block">
                                            <div class="member-name">{name}</div>
                                            <div class="member-designation">{title}</div>
                                            <div class="member-email">
                                                ...
                                                <a class="fill" href={'mailto:'+email}>{email}</a>
                                            </div>
                                            <div class="member-phone">
                                                ...
                                                <a class="fill" href={"tel:"+phone}>{phone} Ext: {extension}</a>
                                            </div>
                                            {cell != '' && (
                                             <div class="member-phone">
                                                   <svg xmlns="http://www.w3.org/2000/svg" width="10.818" height="10.817" viewBox="0 0 10.818 10.817">
                                                   ...
                                                   <a class="fill" href={"tel:"+cell}>{cell}</a>
                                             </div>
                                             )}
                                            
                                            <div class="member-about">{bio}</div>
                     ...
                     <div class="contact-details">
                        ...
                        <div class="grid-member-designation">{title}</div>
                     </div>
                  </div>
                  <div class="contact-details">
                     <span class="email">
